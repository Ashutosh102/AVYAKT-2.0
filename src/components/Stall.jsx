...
function Stall() {
  ...
  const sendRequestandsubmit = async (e) => {
    ...
    const res = await axios
      .post(`https://csefest.d3m0n1k.engineer/stall`, {
    ...
    if (res.status === 200) {
      ...
      toast.success('🦄Veg:- 1000/- / Non-Veg:- 1500/-', {
        position: "top-right",
        autoClose: 12000,
        hideProgressBar: false,
        closeOnClick: true,
                      ...
                      <div className="field">
                        ...
                        >
                          ...
                          <option value={6} onChange={handleChange}>
                            6
                          </option><option value={7} onChange={handleChange}>
                            7
                          </option><option value={8} onChange={handleChange}>
                            8
                          </option><option value={9} onChange={handleChange}>
                            9
                          </option><option value={10} onChange={handleChange}>
                            10
                          </option>
                        </select>
                      </div>
